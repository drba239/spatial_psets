...
load('Counterfactual_economy_constant_fundamentals_tariff_t8.mat', 'Ldyn')
...
print('-dpdf','-r1000','Figure_14_t8.pdf')
close
...
load('F2template.mat') %loads the variable 'template'
setprinttemplate(gcf,template) 
print('-dpdf','-r1000','Figure_15_t8.pdf')
close
...
setprinttemplate(gcf,template) 
print('-dpdf','-r1000','Figure_16_t8.pdf')
close
...
setprinttemplate(gcf,template) 
print('-dpdf','-r1000','Figure_17_t8.pdf')
close
...
load('F4template.mat') %loads the variable 'template'
setprinttemplate(gcf,template) 
print('-dpdf','-r1000','Figure_18_t8.pdf')
close
...
load('F3template.mat') %loads the variable 'template'
setprinttemplate(gcf,template) 
print('-dpdf','-r1000','Figure_19_t8.pdf')
close
...
load('F4template.mat') %loads the variable 'template'
setprinttemplate(gcf,template) 
print('-dpdf','-r1000','Figure_20_t8.pdf')
close
...
load('F4template.mat'); 
setprinttemplate(gcf, template);
print('-dpdf','-r1000','Figure_total_employ_share_comparison_t8.pdf');
close;
...
load('F4template.mat'); 
setprinttemplate(gcf, template);
print('-dpdf','-r1000','Figure_total_employ_comparison_t8.pdf');
close;
